...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Entry.video_url'
        db.add_column(u'kinopom_entry', 'video_url',
                      self.gf('django.db.models.fields.URLField')(max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Entry.video_url'
        db.delete_column(u'kinopom_entry', 'video_url')
